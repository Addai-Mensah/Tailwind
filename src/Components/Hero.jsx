    ...
    return(
        ...
        <div className={`flex-1 ${styles.flexStart} flex-col xl:px-0 sm:px-16 px-6`}>
            ...
            <div className='flex flex-row justify-between items-center w-full'>
                <h1 className='text-white flex-1 font-poppings font-semibold ss:text-[72px] text-[52px] ss:leading-[100px] leading-[75px]'>
            ...
            <h1 className='text-white  font-poppings font-semibold ss:text-[68px] text-[52px] ss:leading-[100px] leading-[75px] w-full'>Payment Method.</h1>
